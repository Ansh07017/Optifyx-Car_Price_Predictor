...
st.sidebar.markdown('<div class="sidebar-title">🚗 Car Price Predictor</div>',
...
try:
    ...
    if page == "Price Prediction":
        ...
        with col1:
            ...
            with st.spinner("Loading prediction models..."):
                ...
                X, y, feature_names, categorical_features, numerical_features = preprocess_data(
            ...
            predict_price(models, df, categorical_features, numerical_features,
                          feature_names)
        ...
        st.markdown(card("📋 Dataset Sample", ""), unsafe_allow_html=True)
        ...
        with col1:
            ...
            st.markdown(card("❓ Missing Values", missing_info),
                        unsafe_allow_html=True)
        ...
        st.markdown(card("🔢 Numerical Features Statistics", ""),
                    unsafe_allow_html=True)
        st.dataframe(df.describe())

        # Distribution of price
        st.markdown(card("📈 Distribution of Car Selling Prices", ""),
                    unsafe_allow_html=True)
    ...
    st.error(
        "Please check if the dataset file exists and is correctly formatted.")
